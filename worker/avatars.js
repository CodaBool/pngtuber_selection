export const AVATARS = {
  crow: {
    ...
    description: "A dark crow with expressive talk frames.",
    sortOrder: 1
  },
  dog: {
    key: "dog",
    ...
    description: "Classic dog pngtuber frames.",
    sortOrder: 2
  },
  talldog: {
    key: "talldog",
    ...
    description: "An elongated dog variant.",
    sortOrder: 3
  },
  raccoon: {
    key: "raccoon",
    ...
    description: "Bandit-mask raccoon avatar.",
    sortOrder: 4
  },
  cat: {
    key: "cat",
    ...
    description: "A cat with clear idle/talk contrast.",
    sortOrder: 5
  },
  hmm: {
    key: "hmm",
    ...
    description: "The pondering hmm expression.",
    sortOrder: 6
  }
};
